  ...
  const handleContactSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: t("about.messageError"),
        variant: "destructive"
      });
    } finally {
    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid md:grid-cols-2 gap-8 mt-12">
                <div className="bg-card p-6 rounded-lg border border-border">
                  ...
                  <h3 className="text-xl font-bold mb-3 text-foreground">{t("about.mission")}</h3>
                ...
                <div className="bg-card p-6 rounded-lg border border-border">
                  ...
                  <h3 className="text-xl font-bold mb-3 text-foreground">{t("about.values")}</h3>
                  <p className="text-muted-foreground">
                    {t("about.valuesDesc")}
                  </p>
                </div>
        ...
        <section className="py-16 bg-muted/30">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-12 text-foreground">{t("about.whyChoose")}</h2>
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              <div className="text-center">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-primary/10 mb-4">
                  <Shield className="h-8 w-8 text-primary" />
                </div>
                <h3 className="text-xl font-semibold mb-2 text-foreground">{t("about.reliability")}</h3>
                <p className="text-muted-foreground">
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold mb-2 text-foreground">{t("about.experience")}</h3>
                <p className="text-muted-foreground">
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold mb-2 text-foreground">{t("about.flexFinancing")}</h3>
                <p className="text-muted-foreground">
                  {t("about.flexFinancingDesc")}
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 bg-background">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl font-bold mb-6 text-foreground">{t("about.contactTitle")}</h2>
      ...
      <Dialog open={isContactFormOpen} onOpenChange={setIsContactFormOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>{t("about.contactForm")}</DialogTitle>
          </DialogHeader>
          <form onSubmit={handleContactSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="contact-phone">{t("about.phone")}</Label>
              <Input
                id="contact-phone"
                type="tel"
            ...
            <Button type="submit" className="w-full" disabled={isSubmitting}>
              {isSubmitting ? t("about.sending") : t("about.send")}
            </Button>
          </form>
